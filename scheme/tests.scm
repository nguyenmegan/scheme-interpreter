...
(cdr (cdr '(first second)))
; expect ()


(begin (define numer 1) (+ numer 9))
; expect 10

(begin False True 2 3 4 5 6 7 False 9)
; expect 9


(define (adder_two num) (+ num 2))
; expect adder_two
adder_two
; expect (lambda (num) (+ num 2))
...
(if (or False 0) (and 1 5 9) (or 1 5 9))
; expect 9
...
(cond ((= 1 0) 'tis_false)
      ((= 1 1) 'tis_true 'tis_very_true)
  )
; expect tis_very_true


(define first 1)
(define second 2)
(define third 3)
(let ((first 5) (second 6) (third 7))
      (+ first second third))
; expect 18
...
(define func (mu (x) (- x y)))
; expect func

(define g (lambda (x y) (func (* x x))))
; expect g
